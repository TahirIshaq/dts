"""Widerface dataset in Yolov5 format using huggingface"""
...
if __name__ == "__main__":
    ...
    convert_to_yolov5_format(wider_face_train, dst_dir=Path(f"{base_path}/train"))
    convert_to_yolov5_format(wider_face_val, dst_dir=Path(f"{base_path}/val"))
    # convert_to_yolov5_format(wider_face_test, dst_dir=Path(f"{base_path}/test"))
